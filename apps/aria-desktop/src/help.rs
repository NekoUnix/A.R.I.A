...
pub fn category_topic(title: &str) -> &'static str {
    match title {
        ...
        "Gamepad input" | "Live controller values" | "Avatar controller poses" => "controller",
        "Response & hand movement" => "controller-response",
        "Other controllers & custom layouts" => "controller-compatibility",
        "Streaming chat" => "stream-chat",
        "Image action library" | "Artwork & trigger" => "image-actions",
        "Fade & transition" => "image-transitions",
        "Animation on change" => "image-motion",
        "GIF playback" => "gif-playback",
        "Image action hotkey" => "hotkeys",
        "Liquid & color" => "sprays",
