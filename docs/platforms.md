...
The v0.33.0-alpha.1 release provides Windows x64, Linux x64, macOS Apple Silicon
...
git clone --branch v0.33.0-alpha.1 https://github.com/NekoUnix/A.R.I.A.git
cd A.R.I.A
...
| --- | --- | --- |
| Windows x64 | `aria-0.33.0-alpha.1-windows-x64.zip` | Extract, run `aria-desktop.exe` |
| Linux x64 | `aria-0.33.0-alpha.1-linux-x64.tar.gz` | Extract, run `./aria-desktop` |
| macOS Apple Silicon | `aria-0.33.0-alpha.1-macos-arm64.zip` | Extract, open `ARIA Alpha.app` |
| macOS Intel | `aria-0.33.0-alpha.1-macos-x64.zip` | Extract, open `ARIA Alpha.app` |
| Fedora x64 | `aria-alpha-0.33.0.alpha.1-1.x86_64.rpm` | Install with DNF; launch ARIA Alpha |
| Arch x64 | `aria-alpha-0.33.0alpha.1-1-x86_64.pkg.tar.zst` | Install with pacman; launch ARIA Alpha |
...
sudo dnf install ./aria-alpha-0.33.0.alpha.1-1.x86_64.rpm ./aria-obs-canvas-0.33.0.alpha.1-1.x86_64.rpm

# Arch: run in the downloaded release folder
sudo pacman -Syu
sudo pacman -U ./aria-alpha-0.33.0alpha.1-1-x86_64.pkg.tar.zst ./aria-obs-canvas-0.33.0alpha.1-1-x86_64.pkg.tar.zst
```
