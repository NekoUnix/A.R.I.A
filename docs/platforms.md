...
The v0.25.0-alpha.1 release provides Windows x64, Linux x64, macOS Apple Silicon
...
| --- | --- | --- |
| Windows x64 | `aria-0.25.0-alpha.1-windows-x64.zip` | Extract, run `aria-desktop.exe` |
